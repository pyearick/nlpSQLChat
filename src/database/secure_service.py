# src/database/secure_service.py - Secure database service with authentication
...
# Backwards compatibility - create an alias to your existing Database class
def Database(server_name: str, database_name: str):
    """Backwards compatibility wrapper"""
    return create_database_service(server_name, database_name)